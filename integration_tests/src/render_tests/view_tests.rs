...
#[test]
fn view_tests() {
    let mut runner = TestRunner::new(render_snapshots_dir_path().join("view"));
    ...
    runner.add(TestCase {
        ...
        steps: test_steps_from_scene(include_str!("./view/constant_width_views_row.scene.json")),
        ..default.clone()
    });
    runner.add(TestCase {
    ...
    runner.add(TestCase {
        ...
        steps: test_steps_from_scene(include_str!("./view/dynamic_width_views_row.scene.json")),
        ..default.clone()
    });
    runner.add(TestCase {
    ...
    runner.add(TestCase {
        ...
        steps: test_steps_from_scene(include_str!("./view/border_radius.scene.json")),
        ..default.clone()
    });
    runner.add(TestCase {
        name: "view/border_radius_clipping",
        steps: test_steps_from_scene(include_str!("./view/border_radius_clipping.scene.json")),
        ..default.clone()
    });
    runner.add(TestCase {
    ...
    runner.add(TestCase {
        ...
        steps: test_steps_from_scene(include_str!("./view/border_width.scene.json")),
        ..default.clone()
    });
    runner.add(TestCase {
        name: "view/box_shadow",
        steps: test_steps_from_scene(include_str!("./view/box_shadow.scene.json")),
        ..default.clone()
    });
    runner.add(TestCase {
        name: "view/box_shadow_sibling",
        steps: test_steps_from_scene(include_str!("./view/box_shadow_sibling.scene.json")),
        ..default.clone()
    });
    runner.add(TestCase {
    ...
    runner.add(TestCase {
        ...
        steps: test_steps_from_scene(include_str!("./view/border_radius_box_shadow.scene.json")),
        ..default.clone()
    });
    runner.add(TestCase {
    ...
    runner.add(TestCase {
        ...
        steps: test_steps_from_scene(include_str!("./view/nested_border_width_radius.scene.json")),
        ..default.clone()
    });
    runner.add(TestCase {
    ...
    runner.add(TestCase {
        ...
        steps: test_steps_from_scene(include_str!("./view/padding_absolute_children.scene.json")),
        ..default.clone()
    });
    runner.add(TestCase {
