...
use compositor_pipeline::{
    ...
    EncodedDataOutputOptions, EncodedOutputEvent, FfmpegH264EncoderOptions,
    FfmpegH264EncoderPreset, InputInitInfo, MediaKind, Mp4InputOptions, Mp4InputSource,
    OutputPixelFormat, Pipeline, PipelineEvent, PipelineOptions, PipelineOutputEndCondition,
    ProtocolInputOptions, QueueInputOptions, RawDataInputOptions, RawDataOutputOptions,
    RawDataOutputVideoOptions, RegisterInputOptions, RegisterOutputOptions,
    RegisterOutputVideoOptions, VideoDecoderOptions, VideoEncoderOptions,
};
