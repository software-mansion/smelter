...
pub struct V8GenericValue(pub(super) CefRc<chromium_sys::cef_v8value_t>);

pub struct V8Undefined(pub(super) CefRc<chromium_sys::cef_v8value_t>);
...
pub struct V8Null(pub(super) CefRc<chromium_sys::cef_v8value_t>);
