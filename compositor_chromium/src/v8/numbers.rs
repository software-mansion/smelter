...
pub struct V8Int(pub(super) CefRc<chromium_sys::cef_v8value_t>);
...
pub struct V8Uint(pub(super) CefRc<chromium_sys::cef_v8value_t>);
...
pub struct V8Double(pub(super) CefRc<chromium_sys::cef_v8value_t>);
