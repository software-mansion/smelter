...
fn main() {
    ...
    use vk_video::{Frame, RateControl, RawFrameData, VideoParameters, VulkanInstance};
    ...
    let mut encoder = vulkan_device
        .crate_encoder(vulkan_device.encoder_parameters_high_quality(
            VideoParameters {
                width,
                height,
                target_framerate: (24, 1),
            },
            RateControl::Vbr {
