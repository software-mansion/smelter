...
impl H264Profile {
    pub(crate) fn to_profile_idc(&self) -> vk::native::StdVideoH264ProfileIdc {
        match self {
            H264Profile::Baseline => vk::native::StdVideoH264ProfileIdc_STD_VIDEO_H264_PROFILE_IDC_BASELINE,
...
impl VulkanDevice {
    ...
    pub fn crate_encoder(self: &Arc<Self>, profile: H264Profile, width: u32, height: u32, gop_size: usize) -> Result<VulkanEncoder, VulkanEncoderError> {
        VulkanEncoder::new(self.clone(), profile, width, height, gop_size)
    }
