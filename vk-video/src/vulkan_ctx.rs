...
impl VulkanDevice {
    ...
    pub fn crate_encoder(self: &Arc<Self>, profile: H264Profile, width: u32, height: u32) -> Result<VulkanEncoder, VulkanEncoderError> {
        VulkanEncoder::new(self.clone(), profile, width, height)
    }
