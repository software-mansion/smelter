...
pub(crate) fn vui(
    fps: u32,
) -> Result<vk::native::StdVideoH264SequenceParameterSetVui, VulkanEncoderError> {
    let vui = vk::native::StdVideoH264SequenceParameterSetVui {
        flags: vk::native::StdVideoH264SpsVuiFlags {
            ...
            _bitfield_1: vk::native::StdVideoH264SpsVuiFlags::new_bitfield_1(
                1, 1, 0, 0, 0, 0, 0, 1, 1, 0, // TODO: b-frames
                0, 0,
            ),
            __bindgen_padding_0: 0,
        },
        aspect_ratio_idc:
            vk::native::StdVideoH264AspectRatioIdc_STD_VIDEO_H264_ASPECT_RATIO_IDC_SQUARE,
        sar_width: 0,
        sar_height: 0,
        video_format: 0,
        colour_primaries: 0,
