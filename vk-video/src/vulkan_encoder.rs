...
use crate::{
    ...
    Frame, H264Profile, RawFrameData, VulkanCommonError, VulkanDevice,
};
...
impl VideoSessionResources<'_> {
    fn new(
        ...
        let max_references = parameters.max_references;
...
impl VulkanEncoder<'_> {
    ...
    pub fn new(
        ...
        Ok(Self {
            ...
            query_pool,
            session_resources,
            idr_period: parameters.idr_period,
            output_buffer,
    ...
    pub fn encode_texture(
        ...
        let (image, _view) = self
            ...
            .convert(
                ...
                &[],
                &[(
                    self.sync_structures.sem_ready_to_encode.semaphore,
