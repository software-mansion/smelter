...
use crate::parameters::{
    EncoderContentFlags, EncoderParametersH264, EncoderTuningMode, EncoderUsageFlags, RateControl,
};
...
#[derive(Debug, Clone, Copy)]
pub struct EncoderParameters<P> {
...
impl VulkanDevice {
    ...
    pub fn encoder_parameters_h264_low_latency(
        &self,
        video_parameters: VideoParameters,
        rate_control: RateControl,
    ) -> Result<EncoderParametersH264, VulkanEncoderError> {
    ...
    pub fn encoder_parameters_h264_high_quality(
        &self,
        video_parameters: VideoParameters,
        rate_control: RateControl,
    ) -> Result<EncoderParametersH264, VulkanEncoderError> {
    ...
    pub(crate) fn validate_and_fill_encoder_parameters<C: EncodeCodec>(
        &self,
        encoder_parameters: EncoderParameters<C::Profile>,
