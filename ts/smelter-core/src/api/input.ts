 ...
 * HTTP request
 */
export function intoRegisterInput(inputRef: InputRef, input: RegisterInput): RegisterInputRequest {
  if (input.type === 'mp4') {
    ...
    return intoWhipRegisterInput(inputRef, input);
