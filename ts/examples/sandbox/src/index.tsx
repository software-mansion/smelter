...
async function run() {
  ...
  console.log(
    'https://smelter-labs.github.io/tools/#whep-player?url=https://puffer.fishjam.io/smelter-test/webrtc/whep/output_1&token=example'
  );
  ...
  console.log(
    'https://smelter-labs.github.io/tools/#whip-streamer?url=https://puffer.fishjam.io/smelter-test/webrtc/whip/input_ffmpeg_h264&token=example'
  );
  ...
  console.log(
    'https://smelter-labs.github.io/tools/#whip-streamer?url=https://puffer.fishjam.io/smelter-test/webrtc/whip/input_vulkan_h264&token=example'
  );
}
void run();
