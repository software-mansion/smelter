...
use super::{
    DmaBufError, DmaBufFrame, Nv12DmaBufDescriptor, missing_required_vulkan_device_extension, nv12,
...
impl DmaBufInterop {
    pub(crate) fn new(device: &wgpu::Device) -> Result<Self, DmaBufError> {
        ...
        let vulkan = VulkanDmaBufDevice {
            external_memory_fd: ash::khr::external_memory_fd::Device::new(&instance, &vk_device),
    ...
    pub(crate) fn export_nv12_texture(
        &self,
        resolution: VideoResolution,
    ) -> Result<Arc<DmaBufFrame>, DmaBufError> {
        nv12::export_nv12_dmabuf_texture(self, resolution)
    }
