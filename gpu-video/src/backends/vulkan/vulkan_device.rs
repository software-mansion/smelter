...
use crate::backends::vulkan::vulkan_decoder::decoders_h264::VulkanBytesDecoderH264;
...
impl VulkanDevice {
    ...
    fn new_from_create_info(
        ...
        let waiter_thread = Arc::new(WaiterThread::spawn(device.clone())?);
    ...
    pub fn create_bytes_decoder_h264(
        ...
        let backend = VulkanBytesDecoderH264::new(
    ...
    pub fn create_bytes_encoder_h264(
        ...
        let parameters = self.validate_and_fill_encoder_parameters(
            ...
            parameters.max_in_flight_submissions,
        )?;
    ...
    pub(crate) fn validate_and_fill_encoder_parameters<C: EncodeCodec>(
        ...
        height: NonZeroU32,
        framerate: Rational,
        max_in_flight_submissions: Option<u32>,
        ...
        Ok(FullEncoderParameters {
            ...
            color_space,
            color_range,
            max_in_flight_submissions: max_in_flight_submissions.unwrap_or(3),
        })
    }
}
