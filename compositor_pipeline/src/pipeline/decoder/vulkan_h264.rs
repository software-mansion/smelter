...
use tracing::warn;
use vk_video::{VulkanDevice, WgpuTexturesDecoder};

use crate::{
    error::{DecoderInitError, InputInitError},
    pipeline::{decoder::VideoDecoder, EncodedChunk, PipelineCtx},
};

pub struct VulkanH264 {
    device: Arc<VulkanDevice>,
    decoder: WgpuTexturesDecoder<'static>,
}

impl VideoDecoder for VulkanH264 {
