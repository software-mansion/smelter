...
use crate::{
    ...
    queue::utils::EmitEventOnce,
};
use crate::{prelude::*, queue::utils::OffsetHandler};
                    ...
                    match sample_batch {
                        ...
                        PipelineEvent::Data(mut sample_batch) => {
                            sample_batch.start_pts =
                                offset.calculate_pts(sample_batch.start_pts, queue_start_pts);
                            sample_batch.end_pts =
                                offset.calculate_pts(sample_batch.end_pts, queue_start_pts);
