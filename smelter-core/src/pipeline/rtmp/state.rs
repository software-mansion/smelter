...
pub(crate) struct RtmpInputConnectionState {
    ...
    pub receiver: Option<Receiver<RtmpStreamData>>,
}
...
impl RtmpInputsState {
    pub(crate) fn update(
        ...
        app: Arc<str>,
        stream_key: Arc<str>,
        receiver: Receiver<RtmpStreamData>,
    ...
    pub(crate) fn take_receiver(
        &self,
        input_ref: &Ref<InputId>,
    ) -> Result<Option<Receiver<RtmpStreamData>>, RtmpServerError> {
        let mut guard = self.0.lock().unwrap();
