...
use crate::{
    pipeline::{
        rtp::{RtpNtpSyncPoint, RtpPacket, RtpTimestampSync},
        webrtc::{
            dynamic_depayloader_stream::DynamicDepayloaderStream,
            dynamic_video_decoder_stream::DynamicVideoDecoderStream,
            listen_for_rtcp::listen_for_rtcp, negotiated_codecs::NegotiatedVideoCodecsInfo,
        },
    },
...
impl InitializableThread for VideoTrackThread {
    ...
    fn init(options: Self::InitOptions) -> Result<(Self, Self::SpawnOutput), Self::SpawnError> {
        ...
        let result_stream = decoder_stream
            ...
            .inspect(|frame| trace!(?frame, "Produced a frame"));
