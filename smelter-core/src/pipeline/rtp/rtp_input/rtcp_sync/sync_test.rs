...
fn test_rtcp_sync_pts_from_zero() {
    ...
    let mut stream_1 = RtpTimestampSync::new(&sync_point, 1_000);
    let mut stream_2 = RtpTimestampSync::new(&sync_point, 1_000);
...
fn test_rtcp_sync_pts_from_non_zero_different_clocks() {
    ...
    let mut stream_1 = RtpTimestampSync::new(&sync_point, 1_000);
    let mut stream_2 = RtpTimestampSync::new(&sync_point, 3_000);
