...
impl InputUploader {
    pub fn upload(
        ...
        for frame in input.frames.entries() {
            ...
            let resolution = frame.visible_rect().expect("Input frame should have visible rect defined");
            ...
            frames.insert(
                id,
                Frame {
                    // TODO(noituri): This might be incorrect if on safari (YUV)
