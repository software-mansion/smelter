...
impl WhipInputBuilder {
    pub fn new() -> Self {
        ...
        Self { name, bearer_token, video: None }
    }
    ...
    fn prompt_name(self) -> Result<Self> {
        let name_input =
            Text::new("Input name (ESC for autogenerated):").prompt_skippable()?;
    ...
    pub fn build(self) -> WhipInput {
        WhipInput { name: self.name, bearer_token: self.bearer_token, video: self.video }
    }
}
