...
impl WhepOutputBuilder {
    pub fn new() -> Self {
        ...
        Self { name, bearer_token, video: None, audio: None }
    }
    ...
    fn prompt_name(self) -> Result<Self> {
        let name_input =
            Text::new("Output name (ESC for autogenerated):").prompt_skippable()?;
    ...
    fn prompt_video(self) -> Result<Self> {
        let video_options =
            vec![WhepRegisterOptions::SetVideoStream, WhepRegisterOptions::Skip];
        let video_selection =
    ...
    fn prompt_audio(self) -> Result<Self> {
        let audio_options =
            vec![WhepRegisterOptions::SetAudioStream, WhepRegisterOptions::Skip];
